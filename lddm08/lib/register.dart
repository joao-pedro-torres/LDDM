...
class _RegisterPage extends State<RegisterPage> {
  ...
  _setData() async {
    ...
    await prefs.setString('psswd', _psswd.text);
    await prefs.setString('gender', _gender!);
    print('setData: [name: ${_name.text}], [phone: ${_phone.text}], '
        '[email: ${_email.text}], [psswd: ${_psswd.text}], [gender: $_gender]');
  }
    ...
    return Scaffold(
      // resizeToAvoidBottomInset: false,
        ...
        body: ListView(
            ...
            children: <Widget> [ Container(width: double.infinity,
